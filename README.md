...
<p align="center">
  ...
  <p align="center">
    <a herf="https://github.com/GeekHirushaDev/fileXstream">
...
> [!NOTE]
> Checkout [python branch](https://github.com/GeekHirushaDev/fileXstream/tree/python) if you are interested in that.
...
> [!NOTE]
> You'll have to [fork](https://github.com/GeekHirushaDev/fileXstream/fork) this repository to deploy to Heroku.
...
- Head over to [releases](https://github.com/GeekHirushaDev/fileXstream/releases) tab, from the *pre release* section, download the one for your platform and architecture.
...
```sh
git clone https://github.com/GeekHirushaDev/fileXstream
cd TG-FileStreamBot
```
...
<img src="https://github.com/GeekHirushaDev/fileXstream/assets/65120517/b5bd2b88-0e1f-4dbc-ad9a-faa6d5a17320" height=300>
